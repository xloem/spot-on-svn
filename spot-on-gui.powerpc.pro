...
QMAKE_CXXFLAGS_DEBUG += -fPIE -fstack-protector-all -mabi=altivec \
...
QMAKE_CXXFLAGS_RELEASE += -fPIE -fstack-protector-all -mabi=altivec \
...
QMAKE_LFLAGS_RPATH =
INCLUDEPATH	+= . ../../. GUI
LIBS		+= -L../../libSpotOn -lGeoIP -lcrypto -lgcrypt -lspoton -lssl
